...
<body> <nav>
    ...
    <i class="fa fa-bars"></i>
       ...
       <ul>
            ...
            <li><a class="active" href="success.jpg">Back</a></li>
        </ul><hr>
    </nav> 
...
<div class="container">
    <div id="inputFields">
        ...
        <form id="userInputForm">
            ...
            <textarea id="contact" name="contact" rows="4" required></textarea><br>
            <label for="about">About Me:</label>
            <textarea id="about" name="about" rows="2" required></textarea><br>
            ...
            <textarea id="certificate" name="certificate" rows="2" required></textarea><br> <!-- Updated to display Projects -->
        </form>
    </div>
    <div id="resumeOutput">
    ...
    if (selectedTemplate === "template1") {
        resumeHTML = `
            <div class="resume">
                ...
                <div class="about">
                    ${about ? '<h1>About</h1><p style="text-align: left;">' + about + '</p>' : ''}
                </div><hr>
                <div class="contact">
    	...
    	resumeHTML = `
    	    <div class="resume">
    	        ...
    	        <div class="content">
    	            <div class="section">
    	                ${about ? '<h2>About</h2><p>' + about + '</p>' : ''}
    	            </div>
    	            <div class="section">
    	                ${follow ? '<h2>Social Media Links</h2><p>' + follow + '</p>' : ''}
    	            </div>
    	            <div class="section">
    	            ...
    	            <div class="section">
    	                ${interests ? '<h2>Projects</h2><p>' + interests + '</p>' : ''}
    	            </div>
    	            <div class="section">
	                ${certificate ? '<h2>certificate</h2><p>' + certificate + '</p>' : ''}
	            </div>
    	        </div>
    	    </div>
    	`;
